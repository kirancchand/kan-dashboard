...
const UserList = ({ returnFunc, formik_values, requestType }: any) => {
  ...
  function handleSelectAllCheckboxRow(
    table: any,
    ...
    if (isAllSelected) {
      ...
      const currentPageIds = new Set(
        allData.map((r: any) => String(r.SerialNo)),
      );
      setSelectedRows((prev) =>
        prev.filter((r) => !currentPageIds.has(String(r.SerialNo))),
      );
      setRowSelection({});
    } else {
      ...
      setSelectedRows((prev) => {
        ...
        const newRows = allData.filter(
          (r: any) => !existingIds.has(String(r.SerialNo)),
        );
        return [...prev, ...newRows];
      });
  ...
  function handleSelectCheckboxRow(
    row: any,
    event: React.ChangeEvent<HTMLInputElement>,
  ) {
    ...
    if (row.getIsSelected()) {
      // Uncheck
      setSelectedRows((prev) =>
        prev.filter((r) => String(r.SerialNo) !== rowId),
      );
          ...
          <Card>
                  ...
                  <Col md="2">
                    <FormGroup>
                      ...
                      <RSelect
                        ...
                        onChange={(ev: any) =>
                          stateFunc(ev, formik.setFieldValue)
                        }
                        options={stateData}
                  ...
                  <Col md="2">
                    <FormGroup>
                      ...
                      <RSelect
                        ...
                        onChange={(ev: any) =>
                          districtFunc(ev, formik.setFieldValue)
                        }
                  ...
                  <Col md="2">
                    <FormGroup>
                      ...
                      <RSelect
                        ...
                        onChange={(ev: any) =>
                          regionFunc(ev, formik.setFieldValue)
                        }
                        options={regionData}
            ...
            <CardFooter className="d-flex justify-content-end">
              <Button
                size="sm"
                color="soft-success"
                onClick={() => returnFunc(selectedRows)}
              >
                Add
              </Button>
            </CardFooter>
