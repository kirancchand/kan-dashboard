...
const tableData = [
  { user_id: 1, splash_name: "BirthDay", image: ""},
  { user_id: 2, splash_name: "Anniversary", image: ""},
  { user_id: 3, splash_name: "Custom", image: ""},
  { user_id: 4, splash_name: "Wedding",image: ""},
  ...
  return (
    <React.Fragment >
         ...
         <div style={{padding:'50px',marginTop:'40px'}}>
             <Link to='/splash'> <Button color="warning"  style={{margin:'20px',padding:'10px 20px',}}>+ Add</Button></Link>
       <Card>
            <CardBody>
       <TableContainer 
        columns={(columns || [])}
