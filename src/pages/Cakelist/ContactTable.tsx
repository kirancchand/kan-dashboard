...
import { fetchgetAllCustomerQuery } from "../../pages/Services/Api";
...
function ContactTable(){
     const [page, setPage] =useState(1);
         ...
         const [contactData, setContactData] = useState<AnalyticsItem[]>([]); 
  ...
  const fetchData = async (reqData: any) => {
   ...
   try {
       const response = await axios.post(fetchgetAllCustomerQuery,reqData, {
         headers: {
